...
from api import get_access_token, sent_prompt_and_get_response

st.logo(icon_image="logo.jpg", image="logo.jpg")

st.title("Чат бот GB8-FR3")
...
if "messages" not in st.session_state:
    st.session_state.messages = [{"role": "ai", "content": "Привет, я Кай! С чем могу тебе помочь?"}]
